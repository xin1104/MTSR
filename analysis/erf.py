import sys
sys.path.append('/mnt/g/MTSR')
from model_zoo.MTSR import buildMTSR
from model_zoo.aaf import buildaaf_l
from model_zoo.carn import carn
from model_zoo.srformer_arch import srformer
import os
import time
...
root_path = '/mnt/g/MTSR/analysis/model_zoo/test_SRFormer_light_DIV2Ksrx4.yml'
...
# copied from https://github.com/DingXiaoH/RepLKNet-pytorch
def visualize_erf(MODEL: nn.Module = None, num_images=100, data_path="/mnt/e/PaperDataSet/Urban100/image_SRF_4/LR",
    ...
    def main(args, MODEL: nn.Module = None):
        ...
        for idx,data_sample in enumerate(test_loader):
            ...
            samples = F.interpolate(data_sample['lq'],size=(256,256))
...
if __name__ == '__main__':
    ...
    init_model = srformer()
    ckpt_path = '/mnt/e/复现实验/MambaIR/MambaIR-mambair/experiments/pretrained_models/lightSR4.pth'
