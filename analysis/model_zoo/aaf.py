...
# def buildaaf_l(upscale=4):
#     return MODEL(scale=upscale,n_feats=32,
#   block_feats=128,
#   n_layers=16,
#   use_hsigmoid = false,
#   use_ca = true,
...
def buildaaf_l(upscale=4):
    ...
    # 2. 创建 args 实例，并赋值各个必需的属性
    args = Args()
    args.n_colors = 3  # 输入图像通道数
    args.n_feats = 32
    args.block_feats = 128
    args.n_layers = 16
    args.scale = upscale
    args.use_hsigmoid = False
    args.use_ca = True
    args.res_scale = 1
    args.rgb_range = 255
